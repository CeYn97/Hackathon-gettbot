...
export default function Header() {
  ...
  const languages = [
    {
      code: "en",
      labelKey: "languages.short.en",
      nameKey: "languages.full.en",
    },
    {
      code: "ru",
      labelKey: "languages.short.ru",
      nameKey: "languages.full.ru",
    },
  ];
    ...
    <>
      <header className="hidden md:flex relative items-center w-full px-[120px] py-3 pb-[18px] bg-[#F9F9F9] border-b border-[#DFDFDF] border-[0.5px]">
        ...
        <div className="flex justify-end items-center gap-8 flex-shrink-0 ml-auto">
          <div className="relative" ref={dropdownRef}>
            ...
            <div
              className={`absolute top-full right-0 mt-2 w-32 bg-[#FFFFFF] border border-[#DFDFDF] border-[0.5px] rounded-[12px] shadow-[0px_2px_8px_0px_rgba(15,15,15,0.12)] overflow-hidden transition-all duration-200 z-15 ${
                isDropdownOpen
      ...
      <header className="flex md:hidden justify-between items-center w-full px-5 py-2 bg-[#F9F9F9] border-b border-[#DFDFDF] border-[0.6px]">
        ...
        <div className="flex items-center gap-2 relative">
          ...
          <div
            className={`absolute top-full left-0 mt-2 w-[360px] bg-[#FFFFFF] border border-[#DFDFDF] border-[0.5px] rounded-[12px] shadow-[0px_2px_8px_0px_rgba(15,15,15,0.12)] overflow-hidden transition-all duration-300 ease-in-out z-15 ${
              isDropdownOpen
