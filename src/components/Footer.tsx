      ...
      <footer className="hidden md:flex flex-col w-full gap-[90px] px-[120px] py-12 bg-[#FFFFFF]">
        ...
        <div className="flex flex-col items-center w-[1272px] gap-6">
          ...
          <div className="flex justify-between items-center w-[1272px]">
            <a
              href="/cookies"
              className="text-[#0C0B16] text-[16px] font-[500] leading-[1.25] text-left hover:text-[#3FC7C8] transition-colors duration-200"
            >
              {t("footer.links.cookies")}
            </a>
            <a
              href="/privacy"
              className="text-[#0C0B16] text-[16px] font-[500] leading-[1.25] tracking-[-0.02em] text-center hover:text-[#3FC7C8] transition-colors duration-200"
            >
              {t("footer.links.privacy")}
            </a>
            <button
              onClick={handleTermsClick}
              className="text-[#0C0B16] text-[16px] font-[500] leading-[1.25] tracking-[-0.02em] text-right hover:text-[#3FC7C8] transition-colors duration-200 cursor-pointer"
            >
      ...
      <footer className="flex md:hidden flex-col w-full gap-10 px-5 py-8 pb-12 bg-[#FFFFFF]">
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex justify-center items-center flex-wrap gap-3">
            <a
              href="/cookies"
              className="text-[#0C0B16] text-[12px] font-[500] leading-[1.17] text-left hover:text-[#3FC7C8] transition-colors duration-200"
            >
              {t("footer.links.cookies")}
            </a>
            <a
            ...
            <button
              onClick={handleTermsClick}
              className="text-[#0C0B16] text-[12px] font-[500] leading-[1.17] text-left hover:text-[#3FC7C8] transition-colors duration-200 cursor-pointer"
            >
              {t("footer.links.terms")}
            </button>
          </div>
